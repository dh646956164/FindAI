...
export default function AboutPage() {
  return <div className="container max-w-5xl py-16">
    <Badge>关于综合平台</Badge>
    <h1 className="mt-6 text-balance text-4xl font-black leading-tight md:text-6xl">让 AI 工具选型<br /><span className="text-primary">少一点噪音，多一点证据</span></h1>
    ...
    <div className="relative mt-12 overflow-hidden rounded-3xl bg-slate-950 p-8 text-white md:p-10">
      ...
      <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center"><img src={assetPath("/brand/gsou-emblem.png")} alt="甘肃开放大学校徽" className="size-24 rounded-full object-contain" /><div><p className="text-sm font-semibold text-indigo-300">甘肃开放大学 · AI 信息综合汇聚平台</p><h2 className="mt-2 text-2xl font-black">由甘肃开放大学相关团队建设维护</h2><p className="mt-3 max-w-2xl text-sm leading-7 text-slate-300">聚焦教学、科研、管理和学习场景，持续收录实用 AI 工具与学校相关 AI 应用探索成果。</p></div></div>
    </div>
