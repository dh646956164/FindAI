...
import { sortByNationalUsage, taskRecommendations } from "@/lib/curated";
  ...
  return <>
    <section className="relative overflow-hidden border-b bg-slate-950 text-white">
      ...
      <div className="container relative py-14 text-center md:py-20">
        ...
        <AnimatedSection delay={.08}><h1 className="mx-auto max-w-5xl text-[2rem] font-black leading-[1.15] tracking-[-0.035em] sm:text-4xl md:text-6xl"><span className="block whitespace-nowrap">甘肃开放大学</span><span className="block bg-gradient-to-r from-cyan-300 via-indigo-300 to-violet-300 bg-clip-text text-transparent">AI大模型与智能体综合平台</span></h1></AnimatedSection>
        <AnimatedSection delay={.16}><p className="text-balance mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-300 md:text-lg">穿越 AI 的星辰大海，发现真正值得使用的智能工具，开启属于你的智能进化。</p></AnimatedSection>
