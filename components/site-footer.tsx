...
export function SiteFooter() {
  ...
  return <footer className="mt-20 border-t bg-slate-950 text-slate-300">
    <div className="container grid gap-10 py-12 md:grid-cols-[1.5fr_1fr_1fr]">
      <div><Logo inverse /><p className="mt-4 max-w-md text-sm leading-7 text-slate-400">由甘肃开放大学信息中心建设维护，围绕真实任务提供大模型、智能体与 AI 工具的精选参考。</p></div>
    ...
    <div className="border-t border-white/10 py-5 text-center text-xs text-slate-500">© 2026 甘肃开放大学信息中心 · AI 大模型与智能体综合平台</div>
  </footer>;
}
